...
export const TERMINAL_THEMES: Record<TerminalThemeId, TerminalThemeConfig> = {
  ...
  /** Shanghai Metro ticket / 交通卡充值 — cool LCD + Apple-rounded type, red accent only */
  shanghai: {
    id: 'shanghai',
    rootBg: '#0A121C',
    fg: '#F5F5F7',
    dim: 'rgba(245, 245, 247, 0.4)',
    /** Accent only (caret / TAP / +) — not body text */
    hot: '#FF3B30',
    screenBg: 'transparent',
    idleLabel: 'TAP',
    startHint: 'TAP',
    prompt: '',
    selection: 'rgba(255, 59, 48, 0.28)',
    scanlines: false,
    chromeDark: true,
  },
